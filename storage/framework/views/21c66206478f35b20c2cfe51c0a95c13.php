        ...
        <div class="email-wrapper">
            ...
            <div class="content">
                ...
                <div class="info-box">
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($name); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Visitor Type</span>
                        <span class="info-value"><?php echo e(ucfirst($visitorType)); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Mobile</span>
                        <span class="info-value"><?php echo e($mobile); ?></span>
                    </div>
                    <div class="info-row">
            ...
            <div class="footer">
                ...
                <p style="margin-top: 20px; color: #6B7280; font-size: 12px;">
                    © <?php echo e(date('Y')); ?> Mayfair. All rights reserved.<br>
...
<?php /**PATH E:\GitProjects\staging\mayfair_VMS\resources\views/emails/welcome.blade.php ENDPATH**/ ?>