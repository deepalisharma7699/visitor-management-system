...
<body>
    <div class="container">
        ...
        <p style="font-size: 16px;">Hello <strong><?php echo e($name); ?></strong>,</p>
        <?php else: ?>
        ...
        <div class="otp-code">
            ...
            <p style="margin: 0; color: #6B7280; font-size: 14px;">⏰ Valid for <?php echo e($expiryMinutes); ?> minutes</p>
        </div>
...
<?php /**PATH E:\GitProjects\staging\mayfair_VMS\resources\views/emails/otp.blade.php ENDPATH**/ ?>