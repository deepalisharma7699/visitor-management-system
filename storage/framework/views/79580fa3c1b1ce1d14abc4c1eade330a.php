...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Verify OTP']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Verify OTP']); ?>
<div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-mayfair-gray rounded-2xl shadow-2xl overflow-hidden border border-mayfair-border">
        <div class="p-6 sm:p-8">
            ...
            <form class="space-y-6" action="<?php echo e(route('visitor.login.verify.submit')); ?>" method="POST" id="verifyForm">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <input id="otp" name="otp" type="text" required maxlength="4" pattern="[0-9]{4}"
                        class="w-full px-4 py-3 bg-mayfair-dark border border-mayfair-border rounded-lg focus:ring-2 focus:ring-mayfair-gold focus:border-mayfair-gold text-white text-center text-2xl tracking-widest font-mono <?php $__errorArgs = ['otp'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('visitor.login')); ?>" class="text-sm font-medium text-mayfair-gold hover:text-yellow-500">
                        ← Back to login
                    </a>
                </div>
            </form>
...
<?php endif; ?>
<?php /**PATH E:\GitProjects\staging\mayfair_VMS\resources\views/visitor/auth/verify-otp.blade.php ENDPATH**/ ?>