    ...
    <div class="bg-mayfair-gray rounded-2xl shadow-2xl overflow-hidden border border-mayfair-border">
        ...
        <div class="bg-mayfair-dark px-6 py-4 border-b border-mayfair-border">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-gray-400 text-sm">Step {{ $currentStep }} of {{ $totalSteps }}</span>
            </div>
        ...
        <div class="p-6 sm:p-8">
            ...
            @if ($currentStep === 2 && !$returningVisitorMode)
                <div class="space-y-6">
                    ...
                    <form wire:submit="sendOTP" class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Selected: {{ $countryCode }} ({{ collect($countries)->firstWhere('dial_code', $countryCode)['name'] ?? 'Unknown' }})
                            </p>
                ...
                <div class="space-y-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-400">
                            ...
                            @if(!$returningVisitorMode)
                                <br><span class="font-semibold text-mayfair-gold">{{ $countryCode }} {{ $mobile }}</span>
                            @endif
                        </p>
                    </div>
                    ...
                    <form wire:submit="verifyOTP" class="space-y-4">
                        <div>
                            ...
                            @error('otp') <p class="mt-1 text-sm text-red-400 text-center">{{ $message }}</p> @enderror
                        </div>
                    ...
                    <form wire:submit="submitDetails" class="space-y-4">
                        ...
                        @if ($visitorType === 'guest')
                            <div>
                                ...
                                @error('guestType') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
                            </div>
                            ...
                            @if ($guestType === 'other')
                                <div>
                                    ...
                                    @error('purposeOfVisit') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
                                </div>
                            @endif

                            @if (in_array($guestType, ['vendor', 'contractor']))
                                <div>
                                    <label class="block text-sm font-medium text-gray-300 mb-2">Company Name *</label>
                                    <input type="text" wire:model="companyName" 
                                           class="w-full px-4 py-3 bg-mayfair-dark border border-mayfair-border rounded-lg focus:ring-2 focus:ring-mayfair-gold focus:border-mayfair-gold text-white placeholder-gray-500"
                                           placeholder="Enter company name">
                                    @error('companyName') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
                                </div>
                            @endif
                            ...
                            <div x-data="employeeSearch()">
                                ...
                                @error('whomToMeet') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
                            </div>
                        ...
                        @if ($visitorType === 'broker')
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Company Name *</label>
                                <input type="text" wire:model="brokerCompany" 
                                       class="w-full px-4 py-3 bg-mayfair-dark border border-mayfair-border rounded-lg focus:ring-2 focus:ring-mayfair-gold focus:border-mayfair-gold text-white placeholder-gray-500"
                                       placeholder="Enter your company name">
                                @error('brokerCompany') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('meetDepartment') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
                            </div>

                            @if ($meetDepartment && $filteredEmployees->count() > 0)
                                <div>
                        ...
                        @if ($visitorType === 'customer')
                            <div>
                                ...
                                @error('interestedProject') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
                            </div>
                        @endif
