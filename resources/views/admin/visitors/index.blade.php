...
<div class="bg-white rounded-lg shadow-sm p-4 mb-6">
    <form method="GET" action="{{ route('admin.visitors.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
        ...
        <div>
            ...
            <select name="type" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                ...
                <option value="broker" {{ request('type') === 'broker' ? 'selected' : '' }}>Broker</option>
        ...
        <div class="md:col-span-4 flex gap-2">
            ...
            <a href="{{ route('admin.visitors.index') }}" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">
                Clear
            </a>
        </div>
    </form>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            ...
                            @if ($visitor->status === 'checked_in')
                                <form action="{{ route('admin.visitors.checkout', $visitor) }}" method="POST" class="inline">
                                    @csrf
